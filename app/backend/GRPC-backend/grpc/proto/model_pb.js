...
goog.exportSymbol('proto.chat.CreateStudentRespose', null, global);
 ...
 * @constructor
 */
proto.chat.CreateStudentRespose = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.chat.CreateStudentRespose, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.chat.CreateStudentRespose.displayName = 'proto.chat.CreateStudentRespose';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.chat.HomeworkData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    attachmenturlsList: (f = jspb.Message.getRepeatedField(msg, 4)) == null ? undefined : f
  };
 ...
 * @return {!Array<string>}
 */
proto.chat.HomeworkData.prototype.getAttachmenturlsList = function() {
 ...
 * @return {!proto.chat.HomeworkData} returns this
 */
proto.chat.HomeworkData.prototype.setAttachmenturlsList = function(value) {
 ...
 * @return {!proto.chat.HomeworkData} returns this
 */
proto.chat.HomeworkData.prototype.addAttachmenturls = function(value, opt_index) {
 ...
 * @return {!proto.chat.HomeworkData} returns this
 */
proto.chat.HomeworkData.prototype.clearAttachmenturlsList = function() {
  return this.setAttachmenturlsList([]);
};
 ...
 * @return {!Object}
 */
proto.chat.CreateStudentRespose.prototype.toObject = function(opt_includeInstance) {
  return proto.chat.CreateStudentRespose.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.chat.CreateStudentRespose} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat.CreateStudentRespose.toObject = function(includeInstance, msg) {
  var f, obj = {
    studentid: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.chat.CreateStudentRespose}
 */
proto.chat.CreateStudentRespose.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.chat.CreateStudentRespose;
  return proto.chat.CreateStudentRespose.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.chat.CreateStudentRespose} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.chat.CreateStudentRespose}
 */
proto.chat.CreateStudentRespose.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.chat.CreateStudentRespose.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.chat.CreateStudentRespose.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.chat.CreateStudentRespose} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat.CreateStudentRespose.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStudentid();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.chat.CreateStudentRespose.prototype.getStudentid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.chat.CreateStudentRespose} returns this
 */
proto.chat.CreateStudentRespose.prototype.setStudentid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
