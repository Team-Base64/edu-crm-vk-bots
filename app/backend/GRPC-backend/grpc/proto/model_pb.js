// source: src/backend/GRPC-backend/grpc/proto/model.proto
/**
 * @fileoverview
 * @enhanceable
 ...
 * @constructor
 */
proto.chat.Status = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.chat.Status, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.chat.Status.displayName = 'proto.chat.Status';
}
 ...
 * @return {!Object}
 */
proto.chat.Status.prototype.toObject = function(opt_includeInstance) {
  return proto.chat.Status.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.chat.Status} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat.Status.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.chat.Status.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.chat.Status;
  return proto.chat.Status.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.chat.Status} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.chat.Status}
 */
proto.chat.Status.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.chat.Status.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.chat.Status.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.chat.Status} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat.Status.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.chat.Status.prototype.getIssuccessful = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.chat.Status} returns this
 */
proto.chat.Status.prototype.setIssuccessful = function(value) {
